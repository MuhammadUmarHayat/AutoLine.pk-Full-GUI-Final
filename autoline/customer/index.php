...
if (isset($_POST['btnviewAll'])) {
    ...
    $result = $con->query("SELECT * FROM products where subCategory='$subCategory' AND category='$category' or title='$title' "); //search button
} else {

    $result = $con->query("SELECT * FROM products"); //view all 
}
...
<!-------------------------------------------------------- search start ------------------------------------------------------------------>
        <div class="col-md-3" >
            <form class="" method="POST" action="index.php">
                <div class="row " style="padding:50px 20px; background-color:cornsilk; ">
                        ...
                        <div class="col-md-4 ">
                            <div class="text-center single-product">
                                ...
                                <div class="product-details">
                                    ...
                                    echo '<br><a class="btn btn-dark" href="ViewProduct.php?id=' . $row['productid'] . '">Add to Cart Now !</a>';
