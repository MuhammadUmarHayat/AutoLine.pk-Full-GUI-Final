        ...
        <div class="col-md-6 align-items-center">
            ...
            <div class="sign-up -page">
                <main class="form-signin text-center ">
                    ...
                    <form method="POST" action="http://localhost/autoline/AdminRegistrationForm.php">
                        ...
                        <div class="form-floating">
                            <input type="tel" class="form-control" id="floatingInputMobile" name="mobile" placeholder="Mobile No">
                            <label for="floatingInput">Enter Mobile Number</label>
                        </div>
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingInputAddress" name="address" placeholder="Address">
